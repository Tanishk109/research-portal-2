...
export const metadata: Metadata = {
  title: "Account Security | Faculty Dashboard",
      ...
      <main className="flex-1 px-4 py-8 md:px-6">
        <div className="container mx-auto grid gap-6">
          <section className="dashboard-hero rounded-lg p-6 text-white md:p-8">
            <p className="text-sm font-medium uppercase tracking-[0.24em] text-cyan-100">Faculty Security</p>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-100 md:text-base">
              Manage account protection and review recent access from one secure workspace.
            </p>
          </section>
